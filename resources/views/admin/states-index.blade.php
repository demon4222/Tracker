    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="new-state-block" hidden>
                <form action="{{action('Admin\AdminController@stateStore')}}" method="POST" class="add-state-form">
                    @csrf
            ...
            <ul class="list-group">
                @foreach($states as $state)
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        ...
                        <div class="actions">
                            <a href="{{action('Admin\AdminController@stateEdit', $state)}}"
                                    class="badge badge-primary badge-pill state-edit-btn">@lang('actions.edit')</a>
                            <form action="{{action('Admin\AdminController@stateDestroy', $state)}}" method="POST">
                                @csrf
                                @method('DELETE')
